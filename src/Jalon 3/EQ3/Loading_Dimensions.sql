COPY Dim_Site(nom_site, code_site) FROM '/EQ3/Loading/Dim_Site.csv' WITH (FORMAT CSV, HEADER);
...
COPY Dim_Plant(plant_id, parcelle_id, date_decouverte) FROM '/EQ3/Loading/Dim_Plant.csv' WITH (FORMAT CSV, HEADER);
